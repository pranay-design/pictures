...
export const FactCardView = ({ item, saved, onSave, onUnsave, onRemove, onMoreLoaded, className }: Props) => {
  ...
  return (
    ...
    >
      ...
      {confirmUnsave && (
        ...
        >
          <div
            className="comic-border-lg bg-card rounded-3xl p-5 max-w-sm w-full space-y-4"
            onClick={(e) => e.stopPropagation()}
          >
            <h2 className="display text-xl">Unsave this fact?</h2>
            <p className="text-sm font-bold text-muted-foreground">
              It'll be removed from your sticker book.
            </p>
